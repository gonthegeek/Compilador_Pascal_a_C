...
int main()
{
    ...
    identidad jacob = {.nombre="Jacob", .tipo="string", .ambito="var", .fila_declaracion=3, .filas_uso=3,6};
    hash_table_insert(&jacob);
    print_table();
    identidad *tmp = hash_table_lookup("Jacob", "var"); // búsqueda a partir de tmp
    if (tmp == NULL)
    {
        printf("Not Found!\n");
    }
    ...
    print_table();
    tmp = hash_table_lookup("Java","pefad");
    if (tmp == NULL)
    {
        printf("Not Found!\n");
    }
    ...
    hash_table_delete("Jacob", "var");
    tmp = hash_table_lookup("Jacob", "var");
    if (tmp == NULL)
    {
        printf("Not Found!\n");
    }
